Use when: Planning the layout and arrangement of elements in any graphic, regardless of output format
Priority: P1
Impact: Without these patterns, non-blog formats lack guidance on visual hierarchy, color restraint, and spatial arrangement — producing cluttered or flat compositions.
