...
- **Left 40-45%:** JetBrains Mono "NEW" badge (small, muted — see `/brand` `references/element-patterns.md` § "JetBrains Mono badge system") → Neue Haas heading (80-100px, weight 95 Black or 75 Bold) → Noto Serif subtitle (16-20px, `text/muted` or `brand/golden-sun` on dark)
...
- JetBrains Mono "INTEGRATION" badge (see `/brand` `references/element-patterns.md` § "JetBrains Mono badge system")
...
See `/brand` `references/composition-guide.md` § "Brand system consistency" for the full lock/vary framework and restraint principle.
...
See also `/brand` `references/composition-guide.md` § "What feels dated" for temporal anti-patterns to avoid.
